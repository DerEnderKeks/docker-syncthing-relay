...
RUN apk add --update ca-certificates curl && \
    curl -L https://build.syncthing.net/job/${NAME}/${curl -L https://build.syncthing.net/job/${NAME}/lastStableBuild/buildNumber | head -n 1}/artifact/${RELEASE}.tar.gz | tar xzf - && \
